        ...
        navContainer.innerHTML = `
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 40px;">
                <button class="tool-card-new tc-blue" onclick="drillDownAccident('tree1', '자동차 vs 자동차')" style="position: relative; display:flex; flex-direction:column; align-items:center; justify-content:center; padding: 40px 20px; border: 1px solid #cbd5e1; border-radius: 12px; background: #fff; cursor: pointer; height: 200px; overflow: hidden; transition: all 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 10px 15px -3px rgba(0, 0, 0, 0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                    ...
                    <div style="position: relative; z-index: 2; font-size: 22px; font-weight: bold; color: #0f172a; text-shadow: 0 2px 4px rgba(255,255,255,0.9), 0 0 10px rgba(255,255,255,0.8);">자동차 vs 자동차</div>
                    <div style="position: relative; z-index: 2; font-size: 15px; color: #334155; margin-top: 8px; font-weight: bold; background: rgba(255,255,255,0.7); padding: 4px 12px; border-radius: 12px;">(기본)</div>
                </button>
                ...
                <button class="tool-card-new tc-slate" onclick="drillDownAccident('tree5', '고속도로/자동차전용도로')" style="position: relative; display:flex; flex-direction:column; align-items:center; justify-content:center; padding: 40px 20px; border: 1px solid #cbd5e1; border-radius: 12px; background: #fff; cursor: pointer; height: 200px; overflow: hidden; transition: all 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 10px 15px -3px rgba(0, 0, 0, 0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-image: url('assets/highway.png'); background-size: cover; background-position: center; opacity: 0.25; z-index: 1; background-color: #cbd5e1;"></div>
                    <div style="position: relative; z-index: 2; font-size: 20px; font-weight: bold; color: #0f172a; text-align: center; text-shadow: 0 2px 4px rgba(255,255,255,0.9), 0 0 10px rgba(255,255,255,0.8);">고속도로/<br>자동차전용도로</div>
                    <div style="position: relative; z-index: 2; font-size: 15px; color: #334155; margin-top: 8px; font-weight: bold; background: rgba(255,255,255,0.7); padding: 4px 12px; border-radius: 12px;">(기본)</div>
                </button>
            </div>
        `;
...
print("script.js UI updated successfully.")
